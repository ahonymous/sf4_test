...
final class Version20190630210132 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE statistic (id INT AUTO_INCREMENT NOT NULL, currency_from_id INT DEFAULT NULL, currency_to_id INT DEFAULT NULL, time DATETIME NOT NULL, unit NUMERIC(10, 2) NOT NULL, INDEX IDX_649B469CA56723E4 (currency_from_id), INDEX IDX_649B469C67D74803 (currency_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
